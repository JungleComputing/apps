...
/*******************************************************************************
* Installation Java Grande Forum Benchmark Suite (Markus Bornemann 19.06.2005) *
*******************************************************************************/

1. Compile and install Ibis see installation instruction of ibis
2. Change directory to <your_ibis_path>/apps/mpj/jgfBenchSuite
3. Compile the benchmarks: ant build

4. The compiled classes will appear in "build" in each secion
   (e.g. <your_ibis_path>/apps/mpj/jgfBenchSuite/section1/build), where applications 
   can be executed.

/************************************************************
* the original installation instruction is obsolete for MPJ *
************************************************************/
