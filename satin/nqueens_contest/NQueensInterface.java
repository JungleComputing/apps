...
interface NQueensInterface extends Spawnable {
    ...
    public long spawn_QueenNotInCorner(int[] board, int N, int spawnLevel, int y, int left, int down, int right, int mask, int lastmask, int sidemask, int bound1, int endbit);
