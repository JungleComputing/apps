...
// This class represents Search on a graph using a queue
public final class BFS_seq {
    // Do Search traversal.
    ...
    public static void main(String args[]) {
        ...
        if(args[1].equals("full")) {
            ...
            System.out.println("\nTotal nodes traveled by Search: " + total + " and Average nodes traveled " + total / 64.0);
        }
        else if(args[1].equals("par")) {
            System.out.println("Following are " + Config.NR_PARALLEL_SEARCHES + " Sequential Breadth First Traversal to find a random node " +
                    "starting from a random node, to test the Search.");
