...
public final class Search_SO extends ibis.satin.SatinObject implements Search_SO_Interface, Serializable {
    ...
    public static void main(String args[]) {
        ...
        if(args[1].equals("full")) {
            ...
            int root = 0;
            int end = number + 1;
            System.out.println("Following is Satin Breadth First Traversals (with shared objects) to find a node not in the graph " +
            ...
            System.out.println("Following are 64 Satin Breadth First Traversal (With shared objects) to find a random node " +
