...
class BFS_SO extends ibis.satin.SatinObject implements BFS_SO_Interface, Serializable {
...
//        boolean directed = true;
        ...
        System.out.println("Following is Breadth First Traversal using Satin (With the use of Shared Objects)"+
