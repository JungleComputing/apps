...
class BFS_SO_IA_G extends ibis.satin.SatinObject implements BFS_SO_IA_Interface, Serializable {
    ...
    public boolean guard_search(Graph g, int node, int target, int count, Visited visited) {
        return visited.iteration == count - 1;
    }
...
//        boolean directed = true;
        ...
        System.out.println("Following is Breadth First Traversal using Satin (With the use of shared objects with Guards and inlet/aborts)"+
