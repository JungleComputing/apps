...
class BFS_SO_IA extends ibis.satin.SatinObject implements BFS_SO_IA_Interface, Serializable {
...
//        boolean directed = true;
        ...
        System.out.println("Following is Breadth First Traversal using Satin (With the use of shared objects and inlet/aborts)"+
