...
{	
	public static String computeAlignment( String alignmentAlgorithm, Reader s1, Reader s2, ScoringScheme scoringScheme ) throws Exception
	{
		...
		{
			throw new Exception( "Non-existant alignment algorithm selected: " + alignmentAlgorithm );
		}
	...
	public static int computeAlignmentScore( String alignmentAlgorithm, Reader s1, Reader s2, ScoringScheme scoringScheme ) throws Exception
	{
		PairwiseAlignmentAlgorithm algorithm = null;
		if( alignmentAlgorithm.equals( SMITH_WATERMAN ) )
		{
