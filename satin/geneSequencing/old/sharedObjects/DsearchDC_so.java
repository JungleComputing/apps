...
public class DsearchDC_so
{
    ...
    {
        System.out.println();
        System.out.println("query sequences    = " + dC.getQuerySeqPointers().size());
        System.out.println("database sequences = " + dC.getDatabaseSeqPointers().size());
