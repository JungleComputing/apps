...
{	
	public static String computeAlignment(String alignmentAlgorithm, Reader s1, Reader s2, ScoringScheme scoringScheme)
                                                                                           throws Exception
	{
	...
	public static int computeAlignmentScore(String alignmentAlgorithm, Reader s1, Reader s2, ScoringScheme scoringScheme)
                                                                                            throws Exception
	{
		PairwiseAlignmentAlgorithm algorithm = null;
		if(alignmentAlgorithm.equals(SMITH_WATERMAN))
